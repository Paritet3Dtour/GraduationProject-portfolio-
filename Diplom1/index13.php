...
<html lang="en">
  ...
  <!-- PHP SCRIPT BEGIN-->
    ...
    <div class="content__buttons">
      <a class="btn btn-primary text-uppercase btn-lg btn__content" href="index12.php" role="button">попередній студент</a>
      <a class="btn btn-primary text-uppercase btn-lg btn__content2" href="index14.php" role="button">наступний студент</a>
      <div class="btn__big">
